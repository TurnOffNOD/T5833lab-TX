...
当前状态：VSCode的代码阅读环境搭建完毕。
> [!Warning]
> 由于还没有offline的license，测试机紧密联系的一套工具程序不一定能跑起来（未作测试），现在搭建起来的只有C代码阅读、C语言跳转等“只读”功能。后续的开发环境搭建待有了license之后再继续。
...
> 但本次搭建过程由于缺少license未作相应试验，因此现在应该看作只有代码阅读功能。
